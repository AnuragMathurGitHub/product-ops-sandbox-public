...
| Field | Value |
| --- | --- |
| Product | FitPass Demo |
| Source | Fictional support tickets |
| Timeframe | Sample week |
| Purpose | Practice feedback classification |

## Notes

1. An employee tried to check in at a partner gym, but the QR code scanner failed twice. The front desk allowed entry manually, but the user was unsure whether the visit counted.

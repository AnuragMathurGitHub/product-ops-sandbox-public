...
- Linked metric: Class Booking Completion Rate
- Evidence: A user arrived for a class without clear confirmation and found it full.
- Possible direction: Improve confirmation states, reminders, and cancellation messaging.
...
1. Which opportunity is most connected to renewal confidence?
2. Which fix can be measured within one release cycle?
3. Which signal needs more evidence before roadmap commitment?

> Structured companion: `ai_opportunity_map.json`.

...
### First value moment depends on local relevance
- Evidence: Users describe the benefit as useful only after finding a nearby partner that fits their routine.
...
1. Which users fail to reach a first successful visit after activation?
2. Which partners create the highest share of support contacts?
3. What launch messages help employees take the next useful action?

> Structured companion: `ai_research_synthesis.json`.
